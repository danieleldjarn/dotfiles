...
sudo apt-get install libssl-dev libbz2-dev libreadline-dev libsqlite3-dev liblzma-dev python3-tk tk-dev # Needed to compile Python (else we get problems with Pyenv)
{
